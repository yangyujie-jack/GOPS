...
tb_tags = {
    ...
    "TAV of RL iteration": "Evaluation/1. TAV-RL iter",
    "TAV of total time": "Evaluation/2. TAV-Total time [s]",
    "TAV of collected samples": "Evaluation/3. TAV-Collected samples",
    "TAV of replay samples": "Evaluation/4. TAV-Replay samples",
